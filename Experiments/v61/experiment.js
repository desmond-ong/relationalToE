...
*/
  ...
  if (numComplete > 0) {
    canvas.clear();
        ...
        hand_right = canvas.image("https://www.stanford.edu/~dco/common/images/hand.png", canvas.width/2 + 5, 112, 64, 48).transform("r90");
        hand_left = canvas.image("https://www.stanford.edu/~dco/common/images/hand_flip.png", canvas.width/2 - 65, 112, 64, 48).transform("r270");

        goButton1 = canvas.rect(canvas.width/2-45,20,90,25,0).attr({fill: "#0f0"});
        //goButtonLabel = canvas.text(canvas.width/4+25,10,"Go!");

        goButton2 = canvas.rect(canvas.width/2-45,30,90,25,0).attr({fill: "#00f"});
              ...
              {transform: "r270,T" + (-canvas.width/4 + 170) + ",0"}, 1000, '<>',  
                function() {
                  spinnerL.animate(
                    ...
                    hand_left.animate({transform: "r270,T" + (-canvas.width/4 + 200) + ",0"}, 500, '<>');
                    }
                );
          });
              ...
              {transform: "r90,T" + (canvas.width/4 - 170) + ",0"}, 1000, '<>',  
                function() {
                  spinnerR.animate(
                    ...
                    hand_right.animate({transform: "r90,T" + (canvas.width/4 - 200) + ",0"}, 500, '<>');
                    }
                );
          });
        } else {

...
The results of fitting Eqn. \ref{RelationalEmotionModel} (i.e., \{$b_1,\ldots, b_6$\}) are presented in Fig. \ref{Expt1Results1}. We note two major results. First, there seems to be no evidence for any dependence across the two attributions. That is, 
